...
<x-layouts.admin title="Edit User">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-charcoal dark:text-gray-100 mt-2">Edit User: {{ $user->name }}</h1>
    </div>
    ...
    <div class="bg-white dark:bg-[#1e1e21] rounded-2xl border border-gray-100 dark:border-gray-800 p-8 max-w-lg">
        <form method="POST" action="{{ route('admin.users.update', $user) }}">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5">Password Baru <span class="text-gray-400 dark:text-gray-500 font-normal">(kosongkan jika tidak ingin ganti)</span></label>
                ...
                <div>
                    <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5">Konfirmasi Password Baru</label>
