...
<x-layouts.admin title="Edit User">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-charcoal mt-2">Edit User: {{ $user->name }}</h1>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 p-8 max-w-lg">
        <form method="POST" action="{{ route('admin.users.update', $user) }}">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label class="block text-xs font-medium text-gray-500 mb-1.5">Password Baru <span class="text-gray-400 font-normal">(kosongkan jika tidak ingin ganti)</span></label>
