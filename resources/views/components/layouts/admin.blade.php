    ...
    <aside class="w-44 bg-white dark:bg-[#1a1a1d] flex flex-col py-6 px-4 fixed top-0 left-0 h-full border-r border-gray-100 dark:border-gray-800 z-20">
        ...
        <nav class="flex flex-col gap-1">
            ...
            <a href="{{ route('admin.discount-codes') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200
               {{ request()->routeIs('admin.discount-codes*') ? 'bg-rose-500 text-white' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-charcoal dark:hover:text-gray-200' }}">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
